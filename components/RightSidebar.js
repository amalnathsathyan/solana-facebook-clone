      ...
      <div className={style.adsContainer}>
        <div className={style.ad}>
          <div className={style.adImageContainer}>
            <Image
              src={
                'https://www.pitsolutions.ch/typo3conf/ext/pits_theme/Resources/Public/img/pits-web.svg'
              }
              height={100}
              width={100}
          ...
          <div>
            <div>
              And now, the power of Blockchain added to the team !! Join as !!
            </div>
            <div className={style.adLink}>pitsolutions.ch/en/jobs</div>
          </div>
        </div>
        <div className={style.ad}>
          <div className={style.adImageContainer}>
